...
import 'package:freshgio/library/data/data_bag.dart';
...
import 'package:freshgio/library/ui/camera/photo_handler.dart';
import 'package:freshgio/library/ui/camera/video_recorder.dart';
import 'package:freshgio/library/ui/media/time_line/media_grid.dart';
import 'package:freshgio/library/ui/project_list/project_chooser.dart';
...
class ProjectMediaTimelineState extends State<ProjectMediaTimeline>
  ...
  void _setQueries(mrm.Project project) async {
    ...
    realmSyncApi.videoStream.listen((event) {
      videos = event;
      _consolidateItems();
      setState(() {
      });
    });
    realmSyncApi.audioStream.listen((event) {
      audios = event;
      _consolidateItems();
      setState(() {
