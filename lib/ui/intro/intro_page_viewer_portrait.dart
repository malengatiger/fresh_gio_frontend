...
import 'package:freshgio/ui/auth/auth_registration_main.dart';
import 'package:freshgio/ui/auth/auth_signin_main.dart';
...
class IntroPageViewerPortraitState extends State<IntroPageViewerPortrait>
  ...
  void _navigateToDashboard(mrm.User mUser) {
    //
    if (mounted) {
