...
import 'package:freshgio/ui/activity/activity_header.dart';
...
class _ActivityListCardState extends State<ActivityListCard> {
  ...
  //   });
  // }
  late Stream<List<mrm.ActivityModel>> myStream = realmSyncApi.orgActivityStream;
  ...
  Widget build(BuildContext context) {
    ...
    late Stream<List<mrm.ActivityModel>> myStream = realmSyncApi.orgActivityStream;
    if (widget.project != null) {
      myStream = realmSyncApi.activityStream;
    }
    return busy
        ? Center(
            child:
        ...
        : Stack(
            children: [
              Column(
                ...
                StreamBuilder<List<mrm.ActivityModel>>(
                    stream: myStream,
              ...
              Positioned(
                ...
                child: Padding(
                  ...
                  child: settings == null
                      ? const SizedBox()
                      : StreamBuilder<List<mrm.ActivityModel>>(
                          stream: widget.project != null? realmSyncApi.activityStream: myStream,
                      builder: (_, snap){
                        if (snap.hasData) {
                          models = snap.data!;
                        }
